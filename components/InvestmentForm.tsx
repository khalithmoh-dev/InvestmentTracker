...
export default function InvestmentForm({ onSave, onCancel, investment }: InvestmentFormProps) {
  ...
  // Update form when investment prop changes
  useEffect(() => {
    if (investment) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // For cash, quantity is always 1 and purchasePrice is the total amount
    ...
    const updatedInvestment: Investment = {
      ...
      purchaseDate,
      // Preserve current price data if editing
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => {
                  ...
                  setQuantity('1'); // Set quantity to 1 for cash
                }}
                className="w-full p-2 border rounded"
